...
def show():
    ...
    def create_3d_plot():
        ...
        ax.set_xlabel('Goals scored from ' + home_team, labelpad=-7, fontsize=8.5)
        ax.set_ylabel('Goals scored from ' + away_team, labelpad=-5, fontsize=8.5)
        ax.set_zlabel('Probability score in percentage', labelpad=-5, fontsize=8.5)
